                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger btn-xs"
                                   href="ProductoServlet?accion=eliminar&id=<c:out value="${producto.entidad.idProducto}"/>">Eliminar</a>
                            </td>
                            <td>
                                <a class="btn btn-success btn-xs"
                                   href="ProductoServlet?accion=actualizar&id=<c:out value="${producto.entidad.idProducto}"/>">Actualizar</a>
                            </td>
                        </tr>
